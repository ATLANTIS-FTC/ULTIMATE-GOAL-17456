...
public class ArmTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory powerShotA = drive.trajectoryBuilder(new Pose2d(-64,43), Math.toRadians(0))
                .splineTo(new Vector2d(5, 30), Math.toRadians(0))
                .build();
        ...
        Trajectory dropWobbleOneA = drive.trajectoryBuilder(powerShotA.end())
                .lineToLinearHeading(new Pose2d(3, 63, Math.toRadians(60)))
                .build();
        ...
        Trajectory dropWobbleTwoA = drive.trajectoryBuilder(pickWobbleTwoACont.end())
                .lineToLinearHeading(new Pose2d(-2, 63.3, Math.toRadians(0)))
                .build();
...
//
                drive.spindexer.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                drive.spindexer.setTargetPosition(-200);
                drive.spindexer.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                runtime.reset();
                drive.spindexer.setPower(-1);
                while (drive.spindexer.getCurrentPosition() > -200 && opModeIsActive()) {}
                drive.spindexer.setPower(0);

                drive.turn(Math.toRadians(-6.7));

                drive.spindexer.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                drive.spindexer.setTargetPosition(-80);
                drive.spindexer.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                runtime.reset();
                drive.spindexer.setPower(-1);
                while (drive.spindexer.getCurrentPosition() > -80 && opModeIsActive()) {}
                drive.spindexer.setPower(0);

                drive.turn(Math.toRadians(-6.7));

                drive.spindexer.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                drive.spindexer.setTargetPosition(-150);
                drive.spindexer.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                runtime.reset();
                drive.spindexer.setPower(-1);
                while (drive.spindexer.getCurrentPosition() > -150 && opModeIsActive()) {}
                drive.spindexer.setPower(0);
