...
public class LinkedMotorTuner extends LinearOpMode {
    public static PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(0.01, 0, 0);
    ...
    public void runOpMode() throws InterruptedException {
        // Change my id
        DcMotorEx myMotor1 = hardwareMap.get(DcMotorEx.class, "s1");
        DcMotorEx myMotor2 = hardwareMap.get(DcMotorEx.class, "s2");
