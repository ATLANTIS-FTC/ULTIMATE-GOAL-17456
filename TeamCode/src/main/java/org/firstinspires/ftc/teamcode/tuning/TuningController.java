...
public class TuningController {
    ...
    public static double MOTOR_MAX_RPM = 3600;
    public static double MOTOR_GEAR_RATIO = 1.36; // output (wheel) speed / input (motor) speed

    public static double TESTING_MAX_SPEED = 1.0 * MOTOR_MAX_RPM;
    public static double TESTING_MIN_SPEED = 0.0 * MOTOR_MAX_RPM;
