...
@Config
@TeleOp(group = "drive")
public class NovaOp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive.boomerServo.setPosition(.3);
        veloTimer.reset();
        veloTimerPwr.reset();
        shooterTimer.reset();
...
//                            .build();
                    ...
                    drive.intakeBlocker.setPosition(ramp);
...
//                    drive.followTrajectory(autoShoot);

                    while (drive.shooterOne.getVelocity() > -1340 && opModeIsActive()) {
                        shooter.targetVelo = -1340;
                        //1340
                ...
                case POWER_SHOTS:
                    ...
                    while (drive.shooterOne.getVelocity() > -1000 && opModeIsActive()) {
                        shooter.targetVelo = -1000;
                        //1340
                        shooter.veloController.setTargetVelocity(shooter.targetVelo);
                        shooter.veloController.setTargetAcceleration((shooter.targetVelo-shooter.lastTargetVelo) / veloTimer.seconds());
